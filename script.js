...
`;
  ...
  mainStyle.innerHTML = `
    ...
    .external-header { position: absolute; top: 3px; right: 20px; left: 20px; display: flex; align-items: center; gap: 12px; z-index: 100; font-family: 'Inter', sans-serif; font-size: 0.9rem; color: #333333; }
